# Pipery Java CI Component

Reusable GitLab CI/CD component for complete Java CI pipeline with structured logging.

## Overview

This component provides a complete CI/CD pipeline for Java projects:
- SAST scanning
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-java-ci/catalog-resources/pipery-java-ci@main
